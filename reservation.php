...
<head>
    ...
    <link href="lib/owlcarousel/assets/owl.carsousel.min.css" rel="stylesheet">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $email = $_POST["email"]; // Assuming your form field for email is named "email"
    $name = $_POST["name1"];
    $time = $_POST["time"];
    $date = $_POST["date"];
    $num = $_POST["num"];

$sql = "INSERT INTO rest (name, email, date, time, company) VALUES ('$name1', '$email', '$date', '$time', '$num')";
...
try {
    ...
    $mail->Password = 'svvj rfpf egbx qbvo'; // Your Gmail password
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
    ...
    $mail->Body = 'Hi ' . $name . ',<br><br>You have booked a table with us. We expect you to arrive at ' . $time . ' on ' . $date . '.';
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 my-5 my-lg-0">
                        <div class="p-5">
                            ...
                            <p class="text-white">Just fill up the form and we will reserve a table for you</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
                            <h1 class="text-white mb-4 mt-5">Book Your Table</h1>
                            <form class="mb-5" method="POST" name="email">
                                <div class="form-group">
                                    <input type="text" name="name1" class="form-control bg-transparent border-primary text-white p-4" placeholder="Name"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control bg-transparent border-primary text-white p-4" placeholder="Email"
                                        required="required" />
                                </div>
                                <div class="form-group">
                                    <div class="date" id="date" data-target-input="nearest">
                                        <input type="text" name="date" class="form-control bg-transparent border-primary text-white p-4 datetimepicker-input" placeholder="Date" data-target="#date" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="time" id="time" data-target-input="nearest">
                                        <input type="text" name="time"class="form-control bg-transparent border-primary text-white p-4 datetimepicker-input" placeholder="Time" data-target="#time" data-toggle="datetimepicker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="number" name="num" class="form-control bg-transparent border-primary text-white p-4" placeholder="Number of people" min="1" max="6"
                                        required="required" />
                                </div>
